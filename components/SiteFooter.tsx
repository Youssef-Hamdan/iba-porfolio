...
const ADDRESS = "Imm. Infinity Center, Bureau n°501, Ave de la Libération, Gombe, République démocratique du Congo";
      ...
      <div className="mx-auto w-[min(100%,80rem)] px-6">
        <div className="relative z-10 -mb-20 md:-mb-24">
          <div className="group relative h-64 overflow-hidden rounded-2xl shadow-[0_24px_60px_-12px_rgba(40,37,97,0.22)] md:h-96">
            <Image
              src={FOOTER_HERO_SRC}
              alt="Chantier et infrastructure"
              fill
              loading="lazy"
        ...
        <div className="rounded-t-3xl bg-iba-navy px-6 pb-16 pt-36 text-white sm:px-8 md:px-12 md:pb-20 md:pt-40">
          <div className="mx-auto max-w-7xl">
            <div className="grid grid-cols-1 gap-12 pb-10 lg:grid-cols-2 lg:gap-16 lg:pb-14">
              ...
              <div className="space-y-10">
                <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:gap-8">
                  ...
                  {/* Text container: NO extra div after this one */}
                  <div className="min-w-0 flex-1">
                    <h3 className="mb-4 text-[11px] font-semibold uppercase tracking-[0.25em] text-iba-sky/90">
                      Réseaux sociaux
                    </h3>
                    <div className="flex flex-wrap gap-3">
                      <a href={WHATSAPP_HREF} target="_blank" rel="noopener noreferrer" className="flex size-11 items-center justify-center rounded-full border border-white/20 text-white transition hover:border-[#25D366] hover:bg-[#25D366] hover:text-white" aria-label="WhatsApp">
                      ...
                      <a href="https://www.instagram.com/iba.steel.rdc?utm_source=qr" className="flex size-11 items-center justify-center rounded-full border border-white/20 text-white transition hover:border-iba-orange hover:bg-iba-orange hover:text-iba-navy" aria-label="Instagram">
                      ...
                      <a href="https://www.tiktok.com/@iba.rdc" target="_blank" rel="noopener noreferrer" className="flex size-11 items-center justify-center rounded-full border border-white/20 text-white transition hover:border-iba-orange hover:bg-iba-orange hover:text-iba-navy" aria-label="TikTok">
                        <svg className="size-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" /></svg>
                      </a>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-6 lg:pl-8 lg:text-right" id="contact">
                ...
                <div className="space-y-6 text-white/80">
                  <p>
                    <span className="block text-[10px] font-semibold uppercase tracking-wider text-iba-sky">Adresse</span>
                    <span className="mt-2 block text-left text-sm font-medium leading-relaxed text-white/90 lg:text-right">{ADDRESS}</span>
                  </p>
                  <p>
                    <span className="block text-[10px] font-semibold uppercase tracking-wider text-iba-sky">Téléphone</span>
                    <a href={PHONE_HREF} className="mt-1 inline-flex items-center gap-2 text-lg font-medium text-white transition hover:text-iba-orange lg:ml-auto">
                      <Phone className="size-4 shrink-0 opacity-80" aria-hidden />
                      {PHONE_DISPLAY}
                    </a>
                  </p>
                  <p>
                    <span className="block text-[10px] font-semibold uppercase tracking-wider text-iba-sky">E-mail</span>
                    <a href={`mailto:${EMAIL}`} className="mt-1 inline-flex items-start gap-2 break-all text-left text-lg font-medium text-white transition hover:text-iba-orange lg:ml-auto lg:text-right">
            ...
            <div className="flex flex-col items-center justify-between gap-6 border-t border-white/15 py-8 md:flex-row">
              ...
              <button type="button" onClick={scrollTop} className="flex items-center gap-2 text-sm text-white/55 transition hover:text-white">
                Haut de page
