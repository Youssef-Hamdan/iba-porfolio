...
export function HomeCatalogSection() {
  ...
  return (
    <section
      id="catalog"
      className="scroll-mt-20 relative z-20 w-full overflow-x-clip bg-iba-navy py-20 text-white md:py-28 lg:py-32"
    >
          ...
          <div className="relative max-w-3xl">
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                ...
                <span className="text-iba-sky">Première.</span>
              </motion.h2>
            </div>
          </div>
        </div>
          ...
          {collections.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Overlay dégradé */}
                <div className="absolute inset-0 bg-gradient-to-t from-white via-white/80 to-iba-navy/20 opacity-95 transition-opacity duration-700 group-hover:opacity-90" />
                ...
                <div className="absolute -top-4 -right-4 p-4 opacity-[0.08] transition-all duration-700 group-hover:opacity-[0.14] group-hover:-rotate-12 group-hover:scale-110">
                  <Icon className="w-24 h-24 text-iba-sky" />
                </div>
                ...
                <div className="relative z-10 flex h-full flex-col justify-between p-5">
                  <div>
                    ...
                    <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl border border-iba-navy/30 bg-iba-navy/15 text-iba-sky backdrop-blur-md transition-all duration-500 group-hover:bg-iba-sky group-hover:text-white group-hover:scale-110 group-hover:border-iba-sky group-hover:shadow-[0_0_15px_rgba(40,37,97,0.25)]">
                      <Icon className="w-5 h-5" />
                    </div>
                    {/* Titre et description (Rétrécis) */}
                    <h3 className="mb-1.5 text-xl font-bold tracking-tight text-iba-sky">
                      {item.title}
                    </h3>
                    <p className="text-xs leading-relaxed text-iba-sky/65 line-clamp-2">
                      {item.desc}
                    </p>
                  </div>
                  ...
                  <div className="mt-4 flex items-center">
                    <Link 
                      href="/products" 
                      className="group/link inline-flex items-center text-[10px] font-bold uppercase tracking-widest text-iba-sky transition-colors hover:text-iba-orange"
                    >
                      Explorer
                      <span className="ml-2 flex h-6 w-6 items-center justify-center rounded-full bg-iba-navy/25 backdrop-blur-sm transition-all duration-300 group-hover/link:bg-iba-orange group-hover/link:text-white group-hover/link:translate-x-1">
        ...
        >
          <motion.div className="absolute inset-0 w-full h-[140%] -top-[20%] z-0" style={{ y: ctaBgY }}>
            ...
            />
              ...
              <div className="absolute inset-0 bg-iba-sky/75 backdrop-blur-[2px] z-10" />
          ...
          <div className="relative z-20 mx-auto max-w-xl flex flex-col items-center">
            ...
            <Link
              href="/projects"
              className="group relative overflow-hidden inline-flex items-center justify-center rounded-full bg-white px-5 py-2.5 text-xs font-bold text-iba-sky transition-all duration-500 hover:scale-105 hover:shadow-[0_0_20px_rgba(255,255,255,0.2)]"
            >
