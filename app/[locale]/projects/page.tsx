...
function ProjectBlock({ project, isEven }: { project: ProjectRecord; isEven: boolean }) {
  ...
  const activeLabel = t("viewLabel", { current: activeImageIndex + 1, total: project.gallery.length });
    ...
    >
      ...
      >
        <button
          ...
          aria-label={t("enlargeProject", { title: project.title })}
        >
          <Image
            src={project.image}
            alt=""
      ...
      <div className="flex w-full flex-col justify-center lg:w-1/2">
        ...
        <p className="mb-8 text-base font-medium leading-relaxed text-iba-muted md:text-lg">
          ...
          {project.objectives && project.objectives.length > 0 && (
            <div className="mb-8">
              <h4 className="mb-3 text-[10px] font-bold uppercase tracking-widest text-iba-sky/60">{t("objectivesHeading")}</h4>
        ...
        <div className="mb-8 flex items-center gap-4 border-y border-iba-sky/10 py-6">
          ...
          <div>
            <p className="text-[9px] font-bold uppercase tracking-widest text-iba-sky/55">{t("locationLabel")}</p>
