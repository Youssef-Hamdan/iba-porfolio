            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-12 lg:col-span-2">
              ...
              <div className="relative border border-iba-sky/15 bg-white p-8 md:p-12 shadow-[0_10px_40px_rgba(40,37,97,0.03)]">
                ...
                <div className="mb-8 flex items-end gap-4 border-b border-iba-sky/10 pb-4">
                  ...
                  <h2 className="text-2xl font-black uppercase tracking-tighter text-iba-navy">{t("sectionId")}</h2>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label htmlFor="quote-name" className="font-mono text-[10px] font-bold uppercase tracking-widest text-iba-navy/70">{t("nameLabel")}</label>
                  ...
                  <div className="space-y-2">
                    <label htmlFor="quote-company" className="font-mono text-[10px] font-bold uppercase tracking-widest text-iba-navy/70">{t("companyLabel")}</label>
                    <div className="relative">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="quote-email" className="font-mono text-[10px] font-bold uppercase tracking-widest text-iba-navy/70">{t("emailLabel")}</label>
                    <div className="relative">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="quote-phone" className="font-mono text-[10px] font-bold uppercase tracking-widest text-iba-navy/70">{t("phoneLabel")}</label>
                    <div className="relative">
              ...
              <div className="relative border border-iba-sky/15 bg-white p-8 md:p-12 shadow-[0_10px_40px_rgba(40,37,97,0.03)]">
                ...
                <div className="mb-8 flex items-end gap-4 border-b border-iba-sky/10 pb-4">
                  ...
                  <h2 className="text-2xl font-black uppercase tracking-tighter text-iba-navy">{t("sectionRequest")}</h2>
                </div>
              ...
              <div className="sticky top-28 space-y-10 border-l border-iba-sky/10 pl-8">
                ...
                <ol className="space-y-6 border-t border-iba-sky/10 pt-8">
                  <li className="flex gap-4">
                    ...
                    <div>
                      <p className="text-xs font-bold uppercase tracking-wider text-iba-navy">{t("step1Title")}</p>
                      <p className="mt-1 text-xs text-iba-navy/65">{t("step1Desc")}</p>
                    </div>
                  </li>
                  <li className="flex gap-4">
                    <span className="font-mono text-2xl font-black text-iba-navy/80">02</span>
                    <div>
                      <p className="text-xs font-bold uppercase tracking-wider text-iba-navy">{t("step2Title")}</p>
                      <p className="mt-1 text-xs text-iba-navy/65">{t("step2Desc")}</p>
                    </div>
                  </li>
                </ol>
      ...
      <section className="relative overflow-hidden bg-iba-navy py-24 text-center text-white">
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-5">
          <h2 className="mb-6 text-3xl font-black uppercase tracking-tight md:text-5xl">
            {t("ctaTitleBefore")}{" "}
            <span className="text-iba-sky">{t("ctaTitleAccent")}</span>
            {t("ctaTitleAfter")}
          </h2>
